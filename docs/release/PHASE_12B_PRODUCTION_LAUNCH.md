...
- ZIP final: 25.340.272 bytes; SHA-256 `7bca0b1c1dc13d01ec84fecd6d3a5aa272ed6e2252f20b9153c425b8a925568e`.
- Reproducibilidad: dos empaquetados consecutivos con el mismo SHA-256 antes del cierre; el paquete final se regeneró tras el último cambio de código y su manifiesto quedó verificado.
...
- Playwright de producción: 43 aprobadas, 5 omitidas de forma prevista.
